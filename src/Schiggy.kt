...
class Schiggy(name: String, lvl: Int, gender: String, private var cEvo: Int, private var isWild: Boolean, pokedexId: Int, attacks: MutableList<Attacke>): Pokemon(name, lvl, gender, pokedexId, attacks){
